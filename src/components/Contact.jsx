        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up ">
                 Reach out today to share your project needs and get started on something amazing!
                </p>
                ...
                <div className="flex items-center gap-2 mt-auto">
                    {socialLinks.map(({href,icon},key) => (
                        ...
                        href={href}
                        target='_blank'
                        className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-orange-100 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up"
                        >
                            {icon}
                        </a>
                    ))}
            ...
            <form 
            action="https://getform.io/f/aejjzdnb"
            method='POST' 
            ...
            >
                ...
                <button 
                type="submit" 
                className="btn btn-primary [&]:max-w-full justify-center reveal-up"
                >
                  Submit
                </button>
